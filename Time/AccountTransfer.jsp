...
<%
String ifsc=session.getAttribute("IFSC").toString();
String aano=session.getAttribute("ANO").toString();
long ano=Long.valueOf(aano);
...
String name=ud.verifyAccount(c);
%>
<body style="background-color:#fffff0;">

<form action="pass3.jsp" method="post">
...
<div class="imgcontainer">
<img src="E:\Akshay Docs\Sample\Easy Transfer\WebContent\img_avatar2.png" alt="Avatar" class="avatar">
</div>
...
<td><input type="text" name="ano" value="<%=name%>" disabled></td>
</tr>
<tr>
