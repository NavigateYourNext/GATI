...
<td><input type="text" name="tid" value="GATRANSUSE<%=c.getTid()%>" disabled></td>
</tr>
<tr>
<th><label><b>Benificiary Details:</b></label></th>
<td><input type="text" name="bname" size="21" value="<%=c.getBenificiary()%>" disabled></td>
</tr>
<tr>
...
<%
SuccessDAO sa=new SuccessDAO();
sa.updateLastTransfer(c);
%>

<div class="back">
<a href="http://localhost:8028/Easy_Transfer/Balance.jsp">Home</a>
</div>
...
<h6><center>(Keep Transfer ID For Future Reference)<center></h6>
</body>
</html>